...
# Get the application directory (parent of scripts)
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
DATASET_PATH = os.path.join(BASE_DIR, "data", "test.jsonl")        # used only if we need to build the collection once
CHROMA_DIR = os.path.join(BASE_DIR, "chroma_db")              # persisted vector store directory
