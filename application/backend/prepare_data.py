...
if __name__ == "__main__":
    ...
    parser.add_argument("--infile", default=os.path.join(BASE_DIR, "data", "sample_dataset.jsonl"))
    parser.add_argument("--outdir", default=os.path.join(BASE_DIR, "data", "hf_dataset"))
